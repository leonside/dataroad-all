    ...
    public DataStream<Row> read(FlinkExecuteContext executeContext) throws Exception {
        DataStream<Row> dataSource = executeContext.getEnvironment().createInput(new JdbcInputFormat.JdbcInputFormatBuilder()
                ...
                .setRowTypeInfo(new RowTypeInfo(new TypeInformation[]{
                        BasicTypeInfo.INT_TYPE_INFO, BasicTypeInfo.STRING_TYPE_INFO, BasicTypeInfo.INT_TYPE_INFO,BasicTypeInfo.INT_TYPE_INFO,BasicTypeInfo.STRING_TYPE_INFO,
                        ...
                        new String[]{"id","name","sex","age","address",
                                "idcard","phone","code","create_time","area_code" }))
                .finish()
        );
        return dataSource;
    }
