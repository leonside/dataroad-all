...
import com.leonside.dataroad.flink.processor.aggeration.config.CountWindowConfigKey;
 ...
 * @author leon
 */
public class CountWindowAggerationProcessor extends ComponentNameAutoGenerator implements ItemAggregationProcessor<FlinkExecuteContext, DataStream<Row>, DataStream<Row>>, ComponentInitialization<FlinkExecuteContext> {
    ...
    public void initialize(FlinkExecuteContext executeContext, Map<String, Object> parameter) {
        countWindowConfig = new CountWindowConfig();
        ConfigBeanUtils.copyConfig(countWindowConfig, parameter, CountWindowConfigKey.class);
