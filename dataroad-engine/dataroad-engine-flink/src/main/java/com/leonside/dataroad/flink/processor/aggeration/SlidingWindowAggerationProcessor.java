...
import com.leonside.dataroad.flink.processor.aggeration.config.SlidingWindowConfigKey;
 ...
 * @author leon
 */
public class SlidingWindowAggerationProcessor extends ComponentNameAutoGenerator implements ItemAggregationProcessor<FlinkExecuteContext, DataStream<Row>, DataStream<Row>>, ComponentInitialization<FlinkExecuteContext> {
    ...
    public void initialize(FlinkExecuteContext executeContext, Map<String, Object> parameter) {
        slidingWindowConfig = new SlidingWindowConfig();
        ConfigBeanUtils.copyConfig(slidingWindowConfig, parameter, SlidingWindowConfigKey.class);
    }
