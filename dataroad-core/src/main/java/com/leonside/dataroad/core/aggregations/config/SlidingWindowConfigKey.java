...
public enum SlidingWindowConfigKey implements ConfigKey {
    ...
    KEY_SLIDESIZE("slideSize","滑动窗口大小",true,"", "滑动窗口大小"),
    ...
    KEY_OUTOFORDERNESS("outOfOrderness","最大延迟时间",false,"0", "最大延迟时间"),
    ;
    private String name;
    ...
    SlidingWindowConfigKey(String name,String cnName,boolean required,String defaultValue, String desc) {
        this.name = name;
        this.cnName = cnName;
        this.desc = desc;
